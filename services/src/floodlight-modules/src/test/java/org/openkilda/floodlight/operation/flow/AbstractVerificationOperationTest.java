...
public abstract class AbstractVerificationOperationTest {
    private final String correlationIdTemplate = String.format(
            "%s-%%d", AbstractVerificationOperationTest.class.getCanonicalName());
    ...
    public void setUp() throws Exception {
        ...
        operationContext = new OperationContext(moduleContext, String.format(correlationIdTemplate, testIndex++));
