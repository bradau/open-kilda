...
public class VerificationListenOperationTest extends AbstractVerificationOperationTest {
    @Before
    @Override
    ...
    public void lackCapabilities() throws Exception {
        ...
        try {
            new VerificationListenOperation(operationContext, request);
        } finally {
            verify(destSwitch);
        }
    }
    ...
    public void run() throws Exception {
        UniFlowVerificationRequest request = makeVerificationRequest();
        VerificationListenOperation subject = new VerificationListenOperation(operationContext, request);
    ...
    public void timeout() throws Exception {
        ...
        VerificationListenOperation.TimeoutNotification timeout = new VerificationListenOperation.TimeoutNotification(
                subject);
