...
public class VerificationListenOperation extends AbstractVerificationOperation {
    private static final Logger log = LoggerFactory.getLogger(VerificationListenOperation.class);
