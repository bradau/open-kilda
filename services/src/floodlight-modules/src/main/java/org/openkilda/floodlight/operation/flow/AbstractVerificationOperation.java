...
abstract class AbstractVerificationOperation extends Operation {
    private final KafkaMessageProducer kafkaProducer;
    private final UniFlowVerificationRequest verificationRequest;

    AbstractVerificationOperation(OperationContext context, UniFlowVerificationRequest verificationRequest) {
        super(context);
